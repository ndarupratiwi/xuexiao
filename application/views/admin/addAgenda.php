            ...
            <div id="content">
                        ...
                        <div class="addAgenda">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="text-center my-2" style="font-family:Tahoma, Arial, Helvetica ;"><img src="<?php echo base_url('assets/image/calendar.png'); ?>" alt=""> 学校议程</h3>
                                </div>
                                <div class="card-body">
                                    <form action="<?php echo base_url('admin/inputAgenda'); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm">
                                                <textarea class="form-control" id="agenda" name="agenda" rows="10" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="datepicker" name="agendaDate" class="form-control datetimepicker-input" data-toggle="datetimepicker" data-target="#datepicker" autocomplete="off" placeholder="YYYY-MM-DD" required />
                                                </div>
                                            </div>
                ...
                <script>
                    $(document).ready(function() {
                        var date_input = $('input[name="agendaDate"]'); //our date input has the name "date"
