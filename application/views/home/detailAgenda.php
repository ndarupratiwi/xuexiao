<div class="container my-5" style="font-family:Tahoma, Arial, Helvetica ;">
    <div class="detailAgenda" style="margin-top: 120px;">
        <div class="col">
            <?php
                ...
                <div class="row">
                    ...
                    <div class="detailAgenda">
                        <div class="text-center my-5">
                            <img src="<?php echo base_url('uploads/agenda/' . $data->image) ?>" width="50%" height="50%" alt="Responsive image">
                        </div>
                        <div class="content" style="text-align: justify;">
                            <h6>日期: <?php echo $data->agendaDate; ?></h6>
                            <h6>时间: <?php echo $data->time; ?></h6>
                            <p><?php echo $data->agenda; ?></p>
                            <br>
                            <span class="text-justify">发布: <?php echo $data->createdDate; ?></span>
                            <br>
