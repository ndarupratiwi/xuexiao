<div class="container my-5" style="font-family:Tahoma, Arial, Helvetica ;">
    <div class="newStudentRegistration" style="margin-top: 120px;">
        <h5 class="text-center">新学生注册信息</h5>
        <div class="animate__animated animate__fadeInDown animate__slower">
            <div class="row">
                <div class="container mt-3">
                    <?php
                    foreach ($newStudentRegistration as $data) {
                    ?>
                        <div class="row bg-light rounded justify-content-between my-3">
                            <div class="row my-3">
                                <div class="col-sm-4">
                                    <img src="<?php echo base_url('uploads/registration_information/' . $data->image) ?>" width="75%" alt="">
                                </div>
                                <div class="col-sm-8">
                                    <h6><?php echo $data->title; ?></h6>
                                    <p class="card-text"><?php echo substr($data->information, 0, 200) . '...'; ?></p>
                                    <a href="<?php echo base_url('Home/detailStudentRegistration/' . $data->id); ?>" class="btn float-right" style="color:white;background-color:#1d5770;">阅读更多</a>
                                </div>
                            </div>
                        </div>
                    <?php
