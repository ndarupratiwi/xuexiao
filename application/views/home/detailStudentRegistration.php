<div class="container my-5" style="font-family:Tahoma, Arial, Helvetica ;">
    <div class="detailStudentRegistration" style="margin-top: 120px;">
        <div class="col">
            <?php
            foreach ($detailStudentRegistration as $data) {
            ?>
                <div class="row">
                    <h4 class="text-center"><?php echo $data->title; ?></h4>
                    <div class="detailStudentRegistration">
                        <div class="text-center my-5">
                            <img src="<?php echo base_url('uploads/registration_information/' . $data->image) ?>" width="50%" height="50%" alt="Responsive image">
                        </div>
