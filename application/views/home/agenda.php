<div class="container my-5" style="font-family:Tahoma, Arial, Helvetica ;">
    <div class="agenda" style="margin-top: 120px;">
        <div class="row">
            <h5 class="text-center">议程</h5>
                ...
                <div class="container mt-3">
                    ...
                    ?>
                        <div class="row bg-light rounded justify-content-between my-3">
                            <div class="row my-3">
                                <div class="col-sm-4">
                                    <img src="<?php echo base_url('uploads/agenda/' . $data->image) ?>" width="75%" alt="">
                                </div>
                                <div class="col-sm-8">
                                    <h6><?php echo $data->title; ?> | <?php echo $data->agendaDate; ?> </h6>
                                    <p class="card-text"><?php echo substr($data->agenda, 0, 200) . '...'; ?></p>
