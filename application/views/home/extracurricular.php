<div class="container my-5" style="font-family:Tahoma, Arial, Helvetica ;">
    <div class="extracurricular" style="margin-top: 120px;">
        <div class="col">
            <div class="row">
                <h5 class="text-center">课外活动</h5>
                    ...
                    <div class="row justify-content-between my-5">
                        ...
                        ?>
                            <div class="card bg-light my-3" style="width: 20rem;">
                                <img class="card-img-top mt-3" src="<?php echo base_url('uploads/extracurricular/' . $data->image) ?>" alt="Card image cap">
                                <div class="card-body">
                                    <h6>课外: <?php echo $data->name; ?></h6>
